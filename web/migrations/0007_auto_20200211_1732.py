# Generated by Django 2.2.5 on 2020-02-11 09:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='class_teacher',
            field=models.ForeignKey(limit_choices_to={'depart__title': '教育质量部'}, on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='web.UserInfo', verbose_name='班主任'),
        ),
        migrations.AlterField(
            model_name='classlist',
            name='teach_teacher',
            field=models.ManyToManyField(blank=True, limit_choices_to={'depart__title__in': ['Python教学部', 'Linux教学部']}, related_name='teach_classes', to='web.UserInfo', verbose_name='讲师'),
        ),
