# Generated by Django 2.2.5 on 2020-02-10 12:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduate_date', models.DateField(blank=True, null=True, verbose_name='结课日期')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='说明信息')),
                ...
                ('teach_teacher', models.ManyToManyField(blank=True, null=True, related_name='teach_classes', to='web.UserInfo', verbose_name='讲师')),
            ],
        ),
    ]
